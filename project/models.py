...
class ProjectInfo(models.Model):
    ...
    pj_except_fee = models.DecimalField(default=0, max_digits=8, decimal_places=2, verbose_name='项目预算费用')
    pj_except_day = models.IntegerField(default=1, verbose_name='项目期望开发周期（天）')
    pj_actual_fee = models.DecimalField(default=0, max_digits=8, decimal_places=2, verbose_name='项目实际费用')
